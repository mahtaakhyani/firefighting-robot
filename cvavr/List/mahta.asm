...
; 0000 003E // Func7=In Func6=In Func5=In Func4=In Func3=In Func2=Out Func1=Out Func0=Out
; 0000 003F // State7=T State6=T State5=T State4=T State3=T State2=0 State1=0 State0=0
...
; 0000 0044 // Func7=In Func6=In Func5=In Func4=Out Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 0045 // State7=T State6=T State5=T State4=0 State3=0 State2=0 State1=0 State0=0
...
; 0000 004A // Func7=In Func6=In Func5=Out Func4=Out Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 004B // State7=T State6=T State5=0 State4=0 State3=0 State2=0 State1=0 State0=0
...
; 0000 009E       r=read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R18,R30
; 0000 009F l=read_adc(1);
	LDI  R26,LOW(1)
	RCALL _read_adc
	MOVW R20,R30
; 0000 00A0 w=read_adc(2);
	LDI  R26,LOW(2)
	RCALL _read_adc
	MOVW R16,R30
; 0000 00A1 PORTD.1=1  ;
...
; 0000 00E2 PORTD.0=0 ;
; 0000 00E3 PORTD.2=1;
; 0000 00E4 delay_ms(3000);
; 0000 00E5 PORTD.0=1 ;
; 0000 00E6 PORTD.2=0;
; 0000 00E7 delay_ms(3000);
; 0000 00E8 PORTD.0=0;
; 0000 00E9 PORTD.2=0 ;
; 0000 00EA PORTC.2=1;
; 0000 00EB PORTC.0=0;
