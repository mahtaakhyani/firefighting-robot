...
; 0000 0032 {
_main:
; 0000 0033 int sensor1;
; 0000 0034 int sensor2;
; 0000 0035 char go;
...
; 0000 0046 // Func7=In Func6=In Func5=In Func4=Out Func3=Out Func2=Out Func1=Out Func0=In
; 0000 0047 // State7=T State6=T State5=T State4=0 State3=0 State2=0 State1=0 State0=T
...
; 0000 00A1 // RS - PORTC Bit 0
; 0000 00A2 // RD - PORTC Bit 1
; 0000 00A3 // EN - PORTC Bit 2
; 0000 00A4 // D4 - PORTC Bit 4
; 0000 00A5 // D5 - PORTC Bit 5
; 0000 00A6 // D6 - PORTC Bit 6
; 0000 00A7 // D7 - PORTC Bit 7
