...
; 0000 003A // Func7=In Func6=In Func5=In Func4=In Func3=In Func2=Out Func1=Out Func0=Out
; 0000 003B // State7=T State6=T State5=T State4=T State3=T State2=0 State1=0 State0=0
...
; 0000 008B // ADC Voltage Reference: AVCC pin
; 0000 008C ADMUX=ADC_VREF_TYPE & 0xff;
	LDI  R30,LOW(64)
	OUT  0x7,R30
; 0000 008D ADCSRA=0x86;
	LDI  R30,LOW(134)
	OUT  0x6,R30
; 0000 008E 
